...
export function NearLogo({ className, fill = "currentColor" }: NearLogoProps) {
  return (
    <svg className={className} fill={fill} role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      <title>NEAR</title>
